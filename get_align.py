...
# 定义文件路径
file_path = '/home/share/huadjyin/home/fanguangyi/liuqifan/test/af_output/'
...
result_df.iloc[:, 0] = result_df.iloc[:, 0].str.replace("/home/share/huadjyin/home/fanguangyi/liuqifan/pdbs/", "")
# 将结果保存为一个新的txt文件
